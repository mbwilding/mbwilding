...
I joined GitHub **10** years ago, pushed **7687** commits, opened **27** issues, submitted **50** pull requests, reviewed **8** pull requests, received **74** stars, own **89** public repositories and contributed to **19** public repositories.
...
Xamarin, WinForms, WPF, Avalonia, DevExpress, Azure DevOps, Entity Framework Core, TypeScript, React, Azure DevOps
